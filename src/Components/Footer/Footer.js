      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <Link to="/" className=" ">
              ...
              <img className="h-20 " src={logoPng} alt="" />
            </Link>
          </div>
          {props.email && (
            <div class="flex flex-col mt-4 items-center space-y-4 ">
              <Input
                className={
                  "relative block w-full rounded-md border-0 p-2 text-gray-900   placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-green-1 "
                }
                placeholder={"Object"}
        ...
        <div class="md:flex md:justify-between">
          <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-base text-white sm:text-center ">
              © 2023{" "}
